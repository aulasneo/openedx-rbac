#!/usr/bin/env python
"""
Package metadata for openedx_rbac.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_rbac', '__init__.py')
...
setup(
    name='openedx-rbac',
    version=VERSION,
    description="""Role based access control (RBAC) engine for Open edX""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='andres@aulasneo.com',
    url='https://github.com/aulasneo/openedx-rbac',
    packages=find_packages(
        include=['openedx_rbac', 'openedx_rbac.*'],
        exclude=["*tests"],
    ),

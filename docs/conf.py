...
"""
openedx-rbac documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-rbac',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/aulasneo/openedx-rbac",
...
#
# html_title = 'openedx-rbac v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Role based access control (RBAC) engine for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_rbac'),
                os.path.join(root_path, 'openedx_rbac/migrations')])
